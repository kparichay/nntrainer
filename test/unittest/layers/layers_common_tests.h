 ...
 */
class LayerSementics
  : public ::testing::TestWithParam<LayerSementicsParamType> {
public:
  /**
   * @brief Destroy the Layer Sementics object
   *
   */
  virtual ~LayerSementics();
